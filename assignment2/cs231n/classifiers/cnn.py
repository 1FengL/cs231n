...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = weight_scale * np.random.randn(num_filters*H*W/4, hidden_dim) #due to padding
    ...
    def loss(self, X, y=None):
        ...
        reg_loss = 0.5 * self.reg * np.sum(np.sum(np.square(W)) for W in [W1, W2, W3])
